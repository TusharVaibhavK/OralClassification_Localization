...
def train_model(model, model_name, train_loader, val_loader, criterion, optimizer, device, num_epochs=50):
    ...
    # Use the specific results directory
    RESULTS_DIR = "Z:/Code/OralClassification/TransformerSegmentationNetwork/results/regular"
...
def main():
    ...
    # Create only the specific results directory we need
    RESULTS_DIR = "Z:/Code/OralClassification/TransformerSegmentationNetwork/results/regular"
    CHECKPOINTS_DIR = "Z:/Code/OralClassification/TransformerSegmentationNetwork/checkpoints"
    os.makedirs(RESULTS_DIR, exist_ok=True)
    os.makedirs(CHECKPOINTS_DIR, exist_ok=True)
    print(f"Using results directory: {RESULTS_DIR}")
    print(f"Using checkpoints directory: {CHECKPOINTS_DIR}")
    ...
    if results:
        ...
        # Save final model to the regular directory with the specified name
        torch.save(model.state_dict(), f"{RESULTS_DIR}/reg_trans_model.pth")
        print(f"Model saved to {RESULTS_DIR}/reg_trans_model.pth")
    else:
        print(
